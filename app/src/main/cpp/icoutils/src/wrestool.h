...
typedef void (*DoResourceCallback) (WinLibrary *, WinResource *, WinResource *, WinResource *,
        WinResource *, const void *);
...
void do_resources (WinLibrary *, const char *, const char *, const char *, DoResourceCallback, const void *);
